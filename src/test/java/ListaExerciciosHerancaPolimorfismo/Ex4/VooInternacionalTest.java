...
class VooInternacionalTest {
    @Test
    void deveInstanciarVooInternacional(){
        VooInternacional voo = new VooInternacional("O1", 1, "D1", "20/05/2025", 1);
    ...
    void deveLancarExcecaoFatorPrecoInvalido(){
        try{
            VooInternacional voo = new VooInternacional("O1", 1, "D1", "20/05/2025", 0);
            fail();
        }
